...
class GuiFrame(wx.Frame):
    ...
    def GetPlugIns(self):
        ...
        self.PIlist = os.listdir(self.hD + r"\plugins\Tools\EtoolsPlugins")
        sys.path.append(self.hD + r"\plugins\Tools\EtoolsPlugins")
        self.toolPlugins=[]
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        wx.Frame.__init__(self, parent, size = (1000, 595),
                          title='Entrez E-Utilities Interface')
        #self.parent = parent
        ...
        for itnum,tool in enumerate(self.toolPlugins):
            ...
            BMP = tool.etPlugin().GetBMP(self.hD)
            self.toolbar.AddSimpleTool(
